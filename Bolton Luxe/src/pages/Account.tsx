      ...
      <div className="space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-2">
              ...
              <input 
                type="text" 
                value={profile.name}
                className="w-full bg-gray-50/50 border-0 rounded-2xl px-5 py-4 focus:ring-1 focus:ring-gray-200 focus:bg-white transition-all text-gray-800 font-normal"
                readOnly
              />
            </div>
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input 
                  type="email" 
                  value={profile.email}
                  className="w-full bg-gray-50/50 border-0 rounded-2xl pl-12 pr-5 py-4 focus:ring-1 focus:ring-gray-200 focus:bg-white transition-all text-gray-800 font-normal"
                  readOnly
                />
              </div>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <section className="bg-white rounded-[2rem] p-8 md:p-10 border border-gray-100 shadow-sm flex flex-col">
            ...
            <textarea 
              ...
              className="w-full flex-1 min-h-[120px] bg-gray-50/50 border-0 rounded-2xl p-5 focus:ring-1 focus:ring-gray-200 focus:bg-white transition-all text-gray-800 font-normal resize-none"
        ...
        <div className="flex justify-end pt-4">
          <button 
            onClick={handleSave}
            disabled={saving}
            className="px-10 py-4 bg-gray-900 text-white font-medium rounded-full hover:bg-gray-800 transition-colors shadow-sm disabled:opacity-50"
          >
