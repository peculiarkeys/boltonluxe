            ...
            <div className="flex flex-col gap-5 w-full flex-1">
               ...
               <div className="pt-2 flex flex-col sm:flex-row gap-3">
                 ...
                 <button 
                    ...
                    className="w-full sm:flex-1 bg-white border border-gray-200 text-gray-800 px-5 py-2.5 rounded-full text-sm font-medium hover:bg-gray-50 transition-colors shadow-sm text-center flex items-center justify-center gap-2"
                  >
